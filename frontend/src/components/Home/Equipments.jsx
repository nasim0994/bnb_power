        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 text-sm">
          ...
          <div className="flex flex-col items-center gap-2">
            <img
              ...
              className="w-28"
            />
            <p className="text-center text-neutral">Primary Current Injector</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <img
              ...
              className="w-28"
            />
            <p className="text-center text-neutral">Circuit Breaker Analyzer</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <img
              ...
              className="w-28"
            />
            <p className="text-center text-neutral">Transformer Oil Tester</p>
          </div>
        </div>
      </div>
    </section>
